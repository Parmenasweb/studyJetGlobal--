      ...
      const formattedData = {
        ...
        personalInfo: {
          ...
          passportExpiry: data.personalInfo.passportExpiry
            ? data.personalInfo.passportExpiry.toISOString()
            : null,
        },
      };
      ...
      if (data.applicationType === "study" && data.studyDetails) {
        formattedData.studyDetails = {
          ...
          englishProficiency: {
            ...
            testDate:
              data.studyDetails.englishProficiency.testDate.toISOString(),
            expiryDate:
              data.studyDetails.englishProficiency.expiryDate.toISOString(),
          },
        };
      }
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="Sponsor's contact information"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
