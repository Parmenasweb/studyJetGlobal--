...
const rentFormSchema = z.object({
  ...
  propertyDetails: z.object({
    ...
    propertyType: z.enum(["office", "warehouse", "retail", "residential", "other"]),
    area: z.string().min(1),
  ...
  leaseDetails: z.object({
    ...
    securityDeposit: z.string().refine((val) => !isNaN(val) && Number(val) >= 0),
...
export function RentForm({ onSubmit, onCancel }) {
  const form = useForm({
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                control={form.control}
                name="leaseDetails.leaseStartDate"
                render={({ field }) => (
              ...
              <FormField
                control={form.control}
                name="leaseDetails.includesUtilities"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">Includes Utilities</FormLabel>
                      <FormDescription>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                control={form.control}
                name="landlordDetails.contactNumber"
                render={({ field }) => (
                  <FormItem>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Enable if this is a recurring rent payment
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          <Button type="submit">Save Rent Entry</Button>
        </div>
      </form>
    </Form>
  );
