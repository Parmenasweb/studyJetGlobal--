...
const utilitiesFormSchema = z.object({
  ...
  utilityDetails: z.object({
    utilityType: z.enum(["electricity", "water", "gas", "internet", "phone", "other"]),
  ...
  rateDetails: z.object({
    baseRate: z.string().refine((val) => !isNaN(val) && Number(val) >= 0),
    taxes: z.string().refine((val) => !isNaN(val) && Number(val) >= 0),
    additionalCharges: z.string().refine((val) => !isNaN(val) && Number(val) >= 0),
  }),
});

export function UtilitiesForm({ onSubmit, onCancel }) {
  const form = useForm({
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                name="utilityDetails.utilityType"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="utilityDetails.propertyName"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="utilityDetails.propertyAddress"
                render={({ field }) => (
                  <FormItem>
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  control={form.control}
                  name="utilityDetails.meterNumber"
                  render={({ field }) => (
                    <FormItem>
                ...
                <FormField
                  control={form.control}
                  name="utilityDetails.accountNumber"
                  render={({ field }) => (
                    <FormItem>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                control={form.control}
                name="usagePeriod.previousReading"
                render={({ field }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="usagePeriod.currentReading"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Current Reading (Optional)</FormLabel>
                    <FormControl>
                      <Input {...field} type="number" min="0" />
                    </FormControl>
                    <FormMessage />
        ...
        <Card>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FormField
                control={form.control}
                name="rateDetails.additionalCharges"
                render={({ field }) => (
                  <FormItem>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Enable if this is a recurring utility payment
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          <Button type="submit">Save Utility Entry</Button>
        </div>
      </form>
    </Form>
  );
