...
const visaAssistanceSchema = z.object({
  // Basic Information
  amount: z.coerce
    .number()
...
export function VisaAssistanceForm({ onSubmit, onCancel, userId }) {
  const form = useForm({
    resolver: zodResolver(visaAssistanceSchema),
    defaultValues: {
      currency: "USD",
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Visa Assistance Fee Entry</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
