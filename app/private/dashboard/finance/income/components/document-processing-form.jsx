...
export function DocumentProcessingForm({ onSubmit, onCancel, userId }) {
  const form = useForm({
    resolver: zodResolver(documentProcessingSchema),
    defaultValues: {
      currency: "USD",
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Document Processing Fee Entry</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
