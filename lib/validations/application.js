...
const englishProficiencySchema = z.object({
  ...
  overallScore: z.number().min(1, "Overall score is required"),
  testDate: z.date({
...
export const applicationSchema = z.object({
  ...
  studyDetails: z.object({
    ...
    fieldOfStudy: z.string().min(1, "Field of study is required"),
    specificProgram: z.string().min(1, "Specific program is required").optional().nullable(),
    ...
    englishProficiency: englishProficiencySchema.optional().nullable(),
  ...
  financialInfo: z.object({
    ...
    annualFamilyIncome: z.number().min(1, "Annual family income is required"),
    hasExistingFunds: z.boolean().optional().nullable(),
  ...
  additionalInfo: z.object({
    previousVisaRejections: z.boolean().optional().nullable(),
    rejectionDetails: z.string().optional(),
    travelHistory: z.array(travelHistorySchema).optional().nullable(),
