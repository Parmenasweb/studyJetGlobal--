...
export const applicationSchema = z.object({
  ...
  studyDetails: z.object({
    ...
    preferredCities: z.array(z.string()).min(1, "At least one preferred city is required"),
    ...
    preferredUniversities: z.array(z.string()).min(1, "At least one preferred university is required"),
